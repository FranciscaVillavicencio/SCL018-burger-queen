        ...
        <div>
          {cartItem.map((item) => (
            <div key={item.id}>
              ...
              <div className="container h-screen bg-gray-300 ">
                <div className="py-12">


                  <div className="max-w-md mx-auto bg-red-400 rounded-lg shadow-lg md:max-w-5xl">
                      ...
                      <div className="w-full p-4 px-5 py-5">
                        <div className="gap-2 md:grid md:grid-cols-3 ">
                          ...
                          <div className="p-5 overflow-visible bg-gray-800 rounded "> <span className="block pb-3 text-xl font-medium text-gray-100">Detalle del Pedido</span>
                            ...
                            <div className="flex flex-col justify-center pt-3"> <label className="text-xs text-gray-400 ">Fecha Envío</label> <input type="date" className="w-full h-6 py-4 text-sm text-white placeholder-gray-300 bg-gray-800 border-b border-gray-600 focus:outline-none" placeholder="**** **** **** ****" /> </div>
                            <div className="grid grid-cols-3 gap-2 pt-2 mb-3">

                              <div className="col-span-2 "> <label className="text-xs text-gray-400">Status</label>
