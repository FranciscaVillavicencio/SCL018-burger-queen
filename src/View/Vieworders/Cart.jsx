                    ...
                    <div className="gap-2 md:grid md:grid-cols-3 ">
                        <div className="col-span-2 p-5">
                         ...
                         <div className="flex items-center justify-between pt-6 mt-6 border-t">
                            ...
                            <div className="flex items-center justify-between pt-6 mt-6 border-t">
                                <div className="flex items-end justify-center"> <span className="mr-1 text-sm font-medium text-gray-400">Subtotal:</span> {totalPrice}<span className="text-lg font-bold text-gray-800 "> $  </span> </div>
                            </div>  
                           </div>
